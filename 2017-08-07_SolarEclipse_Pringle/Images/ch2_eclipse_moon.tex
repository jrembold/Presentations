...
\begin{tikzpicture}[scale=1.4, transform shape]
  ...
  \fill[black!70] let \p1=(umbrat) in (\x1,0) ellipse (2mm and \y1);
  \node[anchor=north, xshift=-1mm] at (umbrat) {\includegraphics[width=0.5cm]{ch2_moon_small2.png}};
  \fill[black!95, opacity=0.5] (eartht) -- (pernumbrat) to[out=0, in=0, looseness=.9] (pernumbrab) -- (earthb) -- cycle;
